...
/// Brute-force vector similarity search using cosine distance.
/// O(n) per query — suitable for small-to-medium corpora (< 100k elements).
/// For larger corpora, swap in an ANN library (e.g. `hnsw_rs`, `usearch`).
